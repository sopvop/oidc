...
let
  sources = {
    ...
    "autoprefixer-8.6.4" = {
      ...
      version = "8.6.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/autoprefixer/-/autoprefixer-8.6.4.tgz";
        sha512 = "10ry8p99j9812jfw1fhkvhsdxmf00hxanpdnvzhs21rysd9jv19fsh066q30q5c119d2q33ldjzl9v8l3l0yw4zj97azal22nihwggl";
      };
    };
    ...
    "caniuse-lite-1.0.30000862" = {
      ...
      src = fetchurl {
        ...
        sha512 = "0s7l8mgn91mv2g5xm35ysd84kbgxk1sdkc6dg1w78xp5gg6lfpx0v83iwww9x0ka8cs1p2f8aj1n61baqsdq3a4dp22wvqfgmwc3l3v";
      };
    };
    "chalk-2.4.1" = {
      name = "chalk";
    ...
    "electron-to-chromium-1.3.51" = {
      ...
      version = "1.3.51";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.51.tgz";
        sha1 = "6a42b49daaf7f22a5b37b991daf949f34dbdb9b5";
      };
    };
    "error-ex-1.3.2" = {
      name = "error-ex";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30000862"
      sources."chalk-2.4.1"
      ...
      sources."electron-to-chromium-1.3.51"
